        ...
        <div class="header-top header-top-ptb-1 d-none d-lg-block">
            <div class="container">
                ...
                <li>
                    ...
                    <select class="language-dropdown changeLang">
                        <option
                            class="{{ session()->get('locale') == 'fa' ? 'language-dropdown-active' : '' }}"
                            value="fa" {{ session()->get('locale') == 'fa' ? 'selected' : '' }}><img
                                src="{{ asset('frontend/assets/imgs/theme/flag-fr.png') }}" alt="" />Farsi
                        </option>
                        <option
                            class="{{ session()->get('locale') == 'en' ? 'language-dropdown-active' : '' }}"
                            value="en" {{ session()->get('locale') == 'en' ? 'selected' : '' }}>English
                        </option>
